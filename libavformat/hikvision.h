...
#define HIKVISION_VIDEO_CODEC_H264  = 0x0001
#define HIKVISION_VIDEO_CODEC_MPEG4 = 0x0300

#define HIKVISION_AUDIO_CODEC_NONE  = 0x1071
#define HIKVISION_AUDIO_CODEC_G711U = 0x1171
